...
import com.example.ImmediateHelpApp.R;
                ...
                if (count == 5) {
                    ...
                    fusedLocationClient.getCurrentLocation(LocationRequest.PRIORITY_BALANCED_POWER_ACCURACY, new CancellationToken() {
                        ...
                        public void onSuccess(Location location) {
                            ...
                            if (location != null) {
                                ...
                                for (ContactModel c : list) {
                                    String message = "Heyiiiii !, " + c.getName() + "Naumwa Tafadhali, Naitaji Msaada wakooo.Pigia simu hospitali ya karibu nipo eneo hili.\n " + "http://maps.google.com/?q=" + location.getLatitude() + "," + location.getLongitude();
                                    smsManager.sendTextMessage(c.getPhoneNo(), null, message, null, null);
                                }
                            } else {
                                String message = "I am in sick, i need help. Please, Naitaji Msaada wakooo.\n" + "GPS was turned off.Couldn't find location. Call your nearest Hospital.";
                                SmsManager smsManager = SmsManager.getDefault();
                                DbHelper db = new DbHelper(SensorService.this);
                                List<ContactModel> list = db.getAllContacts();
                                for (ContactModel c : list) {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            String message = "I am sick, i need help. Please, Naitaji Msaada wakooo.\n" + "GPS was turned off.Couldn't find location. Call your nearest Hospital";
                            SmsManager smsManager = SmsManager.getDefault();
                            DbHelper db = new DbHelper(SensorService.this);
                            List<ContactModel> list = db.getAllContacts();
                            for (ContactModel c : list) {
